...
const noorStack = [{
  ...
  icon: Cog,
  name: "Expo SDK (AV, Haptics, SecureStore)",
  category: "Features"
}];
const noorFeatures = [{
  icon: Smartphone,
        ...
        <button onClick={() => setIsExpanded(!isExpanded)} className="w-full p-6 text-left hover:bg-secondary/30 transition-colors">
          <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              <a href="https://github.com/Maximguyy/Noor-App" target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="p-2 rounded-full bg-secondary/50 text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {["React Native", "Expo", "TypeScript", "Supabase", "IA/Perplexity"].map(tag => <Badge key={tag} variant="secondary" className="text-xs font-normal rounded-full">
                {tag}
              </Badge>)}
          </div>
          ...
          duration: 0.3
              ...
              <div className="px-6 pb-6 space-y-6">
                ...
                setIsFeaturesExpanded(!isFeaturesExpanded);
                    ...
                    <motion.div animate={{
                  rotate: isFeaturesExpanded ? 180 : 0
                }} transition={{
                  duration: 0.2
                }}>
                      <ChevronDown className="h-4 w-4 text-muted-foreground" />
                  ...
                  <AnimatePresence>
                    {isFeaturesExpanded && <motion.div initial={{
                  height: 0,
                  opacity: 0
                }} animate={{
                  height: "auto",
                  ...
                  duration: 0.3
                      ...
                      return <div key={feature.title} className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30">
